...
{               ?>                                      
                                       ...
                                       <!--   <td class="center"><a href="#">Active</a></td>  -->
                                            ...
                                            <input type="button" name="view" value="view" id="<?php echo htmlentities($result->bookid); ?>" class="btn btn-info btn-xs view_data" />

                                             <!-- <button class="btn btn-primary btn-xs view_data" id="<?php echo htmlentities($result->bookid); ?>"><i class="fa fa-edit "></i></button>  -->
                                             <input type="button" name="view" value="view" id="<?php echo htmlentities($result->bookid); ?>" class="btn btn-info btn-xs view_data" />
